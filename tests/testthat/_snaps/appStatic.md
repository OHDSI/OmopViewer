# logo
    ...
    Message
      i styler not installed, code not styled.
    Output
...
# CohortCharacteristics shiny
    ...
    Condition
      Warning:
      The `columns` argument of `addSettings()` is deprecated as of visOmopResults 0.4.0.
      i Please use the `settingsColumns` argument instead.
      Warning:
      The `columns` argument of `addSettings()` is deprecated as of visOmopResults 0.4.0.
      i Please use the `settingsColumns` argument instead.
    Message
