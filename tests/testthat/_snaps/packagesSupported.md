            ...
            sidebar = bslib::sidebar(
              bslib::accordion(
                bslib::accordion_panel(
                  title = "Settings",
                  shinyWidgets::pickerInput(
                    inputId = "summarise_drug_restart_settings_censor_date",
                    label = "Censor date",
                    choices = filterValues$summarise_drug_restart_settings_censor_date,
                    selected = filterValues$summarise_drug_restart_settings_censor_date,
                    multiple = TRUE,
                    options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3")
                  ),
                  shinyWidgets::pickerInput(
